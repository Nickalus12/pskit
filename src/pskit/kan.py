"""Vendored EfficientKAN implementation.

Pure-PyTorch Kolmogorov-Arnold Network from https://github.com/Blealtan/efficient-kan
Vendored to avoid external dependency. MIT License.
"""
